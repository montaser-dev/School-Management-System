  ...
  return (
    ...
    <header>
        ...
        <ul className="flex text-white">
            ...
            <li className="ml-5 px-2 py-1"> <Link to={'/register'}>Register</Link> </li>
            <li className="ml-5 px-2 py-1"> <Link to={'/users'}>Users</Link> </li>
            <li className="ml-5 px-2 py-1 rounded font-semibold bg-gray-200 text-gray-800"> <a href="">DARK MODE</a> </li>
        </ul>
        </div>
        </div>
